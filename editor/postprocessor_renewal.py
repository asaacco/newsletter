...
def generate_section(news_list):
    ...
    for article in news_list:
        section_html += f'''
        <div class="news-item">
            <p style="color: #003366; font-size: 12px; line-height: 1.2;><strong><a href="{article["link"]}">{article["title"]}</strong></a></p>
            <p style="color: #003366; font-size: 12px; line-height: 1.2;>[{article["media_name"]}] ({article["date"]})</p>
            <p style="color: #003366; font-size: 10px; line-height: 1.5;>{article["new_summary_with_insight"]}</p>
        '''
